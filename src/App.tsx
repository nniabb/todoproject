...
import './App.css';
import DisplayGroups from './Components/DisplayTodos';
...
//       >
//         {groups.map((group) => (
//           <GroupDiv key={group.id}>
//             <GroupName>
//               <H3>{group.title}</H3>
//               <DeleteGroup onClick={() => handleGroupDelete(group.id)}>delete</DeleteGroup>
//             </GroupName>
//             <Taskside>
//               <Input
...
//                     />
//                     <H4 style={{ textDecoration: todo.completed ? 'line-through' : 'none' }}>{todo.text}</H4>
//                   </Leftside>
//                   <Rightside>
